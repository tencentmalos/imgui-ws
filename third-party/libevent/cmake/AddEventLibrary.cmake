...
macro(add_event_library LIB_NAME)
    ...
    if (${EVENT_LIBRARY_STATIC})
        ...
        if(LIB_INNER_LIBRARIES)
            set(INNER_LIBRARIES "${LIB_INNER_LIBRARIES}")
        endif()
        ...
        set(ADD_EVENT_LIBRARY_INTERFACE "${LIB_NAME}")
    elseif (${EVENT_LIBRARY_SHARED})
        ...
        if (NOT WIN32)
            install(FILES
                "$<TARGET_FILE_DIR:${LIB_NAME}>/${LIB_LINK_NAME}"
                DESTINATION "lib"
                COMPONENT lib)
        endif()
    endif()

    set_target_properties(${LIB_NAME} PROPERTIES FOLDER Spatial.Foundation/ThirdParty)
