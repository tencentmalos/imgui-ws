// OpenGL-based client for remote ImGui
...
OpenGLImGuiClient::OpenGLImGuiClient() {
    window_ = nullptr;
...
bool OpenGLImGuiClient::initialize(int window_width, int window_height, const char* title) {
...
bool OpenGLImGuiClient::connect(const std::string& server_ip, int port) {
...
bool OpenGLImGuiClient::setupGLFWWindow() {
    // Setup GLFW
...
bool OpenGLImGuiClient::setupOpenGL() {
    // For this demo, we'll assume OpenGL setup is successful
    // In a real application, you might want to check OpenGL capabilities
    return true;
}

void OpenGLImGuiClient::cleanup() {
    if (window_) {
...
void OpenGLImGuiClient::setupImGui() {
...
void OpenGLImGuiClient::renderFrame() {
...
void OpenGLImGuiClient::renderImGui() {
    // Main menu bar
    ...
    // Main window
    {
        ...
        ImGui::Text("This is an OpenGL-based ImGui client for testing remote rendering");
    ...
    // Demo window (using ImGui's built-in demo)
    ...
    // Status bar
    {
        ...
        ImGui::Text("Remote ImGui Client | OpenGL Rendering | Press ESC to exit");
        ImGui::End();
    }
}

void OpenGLImGuiClient::run() {
    if (!initialized_ || !window_) {
        std::cerr << "Client not initialized!" << std::endl;
        return;
    }

    std::cout << "Starting OpenGL ImGui client main loop..." << std::endl;
    ...
    std::cout << "OpenGL client main loop ended" << std::endl;
}

int main(int argc, char** argv) {
    OpenGLImGuiClient client;
